...
class ExtendedDetailsPageViewModel extends BasePageViewModel {
  final HomeUseCase _homeUseCase;
  final ExtendedDetailsPageArguments _movieDetailsPageArguments;
  TabController tabController;

  ExtendedDetailsPageArguments get movieDetailsArguments => _movieDetailsPageArguments;
